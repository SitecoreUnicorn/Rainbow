...
using Rainbow.Model;
using Rainbow.SerializationFormatting;
...
{
	public class IndexedTransactionalFileSystemDataStore : IndexedDataStore
	{
		...
		public IndexedTransactionalFileSystemDataStore(string rootPath, IFileSystemPathProvider pathProvider, ISerializationFormatter formatter, IIndexFormatter indexFormatter)
